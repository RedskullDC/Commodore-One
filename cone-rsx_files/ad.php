...
function AD_reloadPage(init) {
	...
	if (AD_clientWindowSize) {
		...
		AD_setPos('ADIMG',AD_windowWidth-751,'');
	}
}
...
'<td width="21" height="22" align=center nowrap class="adstyle1"><img src="http://ads.tripod.lycos.de/ad/img/de/pub_onglet.gif" border="0" width="21" height="22"></td>'+
'<td height="22" align=center nowrap class="adstyle1"><a href="http://www.jubiiblog.de" target="ad_url" class="adstyle1">Blog was Du fühlst auf www.Jubiiblog.de</a></td>'+
'<td width="21" height="22" align=center nowrap class="adstyle1"><img src="http://ads.tripod.lycos.de/ad/img/de/pub_onglet.gif" border="0" width="21" height="22"></td>'+
...
// skin 0
document.writeln('<div id="ADIMG" style="position:absolute; top:23px; left:0px; width:751px; visibility:hidden; z-index:1003;">'+
'<table width="751" border="0" cellspacing="0" cellpadding="0">'+
'<tr><td width="728" align="center" valign="middle">');

document.writeln('<div id="AD" style="width:728px; overflow: hidden; text-align: right;">');

document.writeln("<iframe name=\"adcreative\" id=\"adcreative\" src=\"http://fe.lea.lycos.de/html.ng/grp=build_a_site&country=de&affiliate=detripod&svc=hosting&adpos=1&ch=science&sch=technology&ee=1&params.styles=tripod,tripod-im&btype=1&btype=27&ts=1475097717?\" width=\"728\" height=\"90\" frameborder=\"0\" marginwidth=\"0\" marginheight=\"0\" vspace=\"0\" hspace=\"0\" scrolling=\"no\" allowTransparency=\"true\"></iframe>");
